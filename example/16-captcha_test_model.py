# USAGE
# python 16-captcha_test_model.py --input downloads --model output/lenet.hdf5

# import the necessary packages
from keras.preprocessing.image import img_to_array
from keras.models import load_model
from datasets.captcha.captchahelper import preprocess
...
test_image_path='../test_images/captcha'
model_path='../saved_models/captcha_model.hdf5'
...
imagePaths = list(paths.list_images(test_image_path
                                    ))
