# USAGE
# python 22-train_models.py --output output --models models
...
from net.minivggnet import MiniVGGNet
...
output_path='../output'
model_path='../saved_models/ensembles'
num_models=3
epochs=20
...
for i in np.arange(0, num_models):
	...
	p = [output_path, "model_{}.txt".format(i)]
	f = open(os.path.sep.join(p), "w")
	f.write(report)
	f.close()

	# plot the training loss and accuracy
	p = [output_path, "model_{}.png".format(i)]
